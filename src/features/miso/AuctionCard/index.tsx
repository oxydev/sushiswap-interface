        ...
        >
            <div className="bg-dark-900 relative flex flex-col gap-3 z-[10]">
                            ...
                            <QuestionHelper
                                ...
                                icon={
                                    <SolidQuestionMarkCircleIcon
                                        width={10}
                                        height={10}
                                        className="text-secondary mb-[2px]"
                                    />
                                }
                            />
                        </div>
                        <Typography variant="xs" weight={700}>
                            {formatNumber(auction.tokenPrice?.toSignificant(6))}{' '}
                ...
                <div className="flex flex-col">
                    ...
                    <div
                        className={classNames(
                            'flex flex-col flex-grow px-3 px-4 py-2 divide-y bg-dark-800 divide-dark-700'
                        )}
                    >
